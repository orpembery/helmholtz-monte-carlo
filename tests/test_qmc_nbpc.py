...
def test_every_point_a_preconditioner_realistic():
    """Tests for expected behaviour when every point is a preconditioner and physically_realistic is True."""
...
def test_one_point_a_preconditioner_realistic():
    """Tests for expected behaviour when only one point is a preconditioner and physically realistic is True."""
